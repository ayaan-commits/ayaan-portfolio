...
const experiences = [
  {
    ...
    company: "Prodigy Flow AI",
    period: "Aug 2024 - Present",
    description: "Building AI-powered automation solutions and voice agents. Scaled business operations from Rs 8L to Rs 40L monthly through intelligent workflows.",
    achievements: [
      "Built 50+ production-ready n8n workflows",
      "Built AI voice agents with Retell AI",
      "Created multi-channel outreach automations",
    ],
  },
  {
    ...
    achievements: [
      ...
      "Integrated Twilio for SMS/WhatsApp features",
      "Saved clients 1000+ hours of manual work",
    ],
  },
  {
    ...
    company: "BIT Durg",
    period: "2021 - 2025",
    description: "Pursuing degree with focus on technology and software development. Building automation projects and learning modern web technologies.",
    achievements: [
      "Developed multiple technical projects",
      "Self-learned n8n, React, Next.js, Python",
      "Started freelancing while in college",
    ],
  },
];
